...
const Footer = () => {
  return (
    <footer className="footer">
      <div className="footer__grid container grid">
        <div className="footer__content">
          ...
          <p className="footer__description">
            We are many variations of passages avaliable but the majority have
          ...
          <ul className="footer__contact">
            ...
            <li className="footer__contact-item">
              <MdOutlineLocationOn className="icon" /> 25/B Milfrod Road, New
              York
            </li>
        ...
        <p className="footer__description">Subscribe Our Newsletter To Get Latest Update And News</p>
      ...
      <p className="copyright__text"> &copy; Copyright 2023 <span>Coffero</span> All Rights Reserved.</p>
    </footer>
  );
};
